...
class ValkeyVectorStoreComponent(LCVectorStoreComponent):
    ...
    def build_vector_store(self):
        ...
        # Monkey-patch check_index_exists to handle RequestError from valkey-glide.
        # langchain-aws only catches KeyError/ValueError/RuntimeError, but glide
        # raises RequestError when the index doesn't exist yet.
        try:
        ...
        logger.info("Valkey: documents after filtering", total=len(documents))
